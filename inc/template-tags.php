...
if ( ! function_exists( 'synthesiscapital_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function synthesiscapital_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'synthesiscapital' ),
...
if ( ! function_exists( 'synthesiscapital_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function synthesiscapital_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'synthesiscapital' ),
...
if ( ! function_exists( 'synthesiscapital_entry_footer' ) ) :
	/**
...
if ( ! function_exists( 'synthesiscapital_post_thumbnail' ) ) :
	/**
